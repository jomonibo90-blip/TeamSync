...
namespace TeamSync.Migrations
{
    ...
    [Migration("20260731140524_AddFileAttachmentsAndContributionHistoriesTables")]
    partial class AddFileAttachmentsAndContributionHistoriesTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamSync.Models.AlertPreference", b =>
                {
                    ...
                    b.Property<int?>("DigestDayOfWeek")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ReceiveApprovalRejectionAlerts")
                        .HasColumnType("bit");

                    b.Property<bool>("ReceiveCommentAlerts")
                        .HasColumnType("bit");

                    b.Property<bool>("ReceiveGroupAlerts")
                        .HasColumnType("bit");

                    b.Property<bool>("ReceiveStatusChangeAlerts")
                        .HasColumnType("bit");

                    b.Property<bool>("ReceiveTaskAssignmentAlerts")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TeamSync.Models.AlertPreference", b =>
                {
                    b.HasOne("TeamSync.Models.User", "User")
                        .WithOne("AlertPreference")
                        .HasForeignKey("TeamSync.Models.AlertPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamSync.Models.ContributionOverride", b =>
                {
                    ...
                    b.HasOne("TeamSync.Models.User", "DisputedBy")
                        .WithMany()
                        .HasForeignKey("DisputedById")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TeamSync.Models.User", "OverriddenBy")
                        .WithMany()
